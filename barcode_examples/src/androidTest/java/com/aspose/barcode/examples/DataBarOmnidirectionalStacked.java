...
public class DataBarOmnidirectionalStacked extends CodeExample
{
    @Before
    public void setUp()
    {
    ...
    {
        String filePath = CommonAssist.getTestsDataFolderPath("examples") + "DataBarOmnidirectionalStacked.png";
        //generate
